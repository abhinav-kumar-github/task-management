...
public class TaskService {
    ...
    public static void add_new_task_service_dummy() throws ParseException {
    ...
    public static ResponseTaskDto add_new_task_service(NewTaskDto newTaskDto) throws ParseException {
        return TaskRepo.add_task(newTaskDto);
    }
}
